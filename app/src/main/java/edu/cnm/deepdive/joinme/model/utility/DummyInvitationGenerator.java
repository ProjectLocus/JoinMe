  ...
  public static List<Invitation> getXDummyInvitations(boolean isReceivedInvite, Person theUser, Context context, int xDummies){
    ...
    for (int i = 0; i < xDummies; i++) {
      ...
      if(isReceivedInvite){
        ...
        tempInvitation.setDescription("An invite To: you.  From: " + tempInvitation.getUserSender().getDisplayName());
      }else{
        ...
        tempInvitation.setDescription("An invite To: " + tempInvitation.getUserReceiver().getDisplayName() + "From: you.");
      }
